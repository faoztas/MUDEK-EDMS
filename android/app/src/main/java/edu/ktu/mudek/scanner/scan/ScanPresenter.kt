...
import edu.ktu.mudek.scanner.SourceManager
import edu.ktu.mudek.scanner.crop.CropActivity
import edu.ktu.mudek.scanner.processor.Corners
import edu.ktu.mudek.scanner.processor.processPicture
...
class ScanPresenter constructor(private val context: Context, private val iView: IScanView.Proxy)
    ...
    fun initCamera() {
        try {
            ...
            e.stackTrace
            Toast.makeText(context, "cannot open camera, please check camera", Toast.LENGTH_SHORT).show()
            return
        }
